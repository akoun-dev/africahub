  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
          ...
          <NavigationMenuContent>
            <div className="grid grid-cols-2 gap-4 p-6 w-[500px]">
              {sectors?.slice(0, 6).map((sector) => {
                const IconComponent = sectorIcons[sector.slug as keyof typeof sectorIcons] || Building;
                return (
        ...
        <NavigationMenuItem>
          <Link to="/compare" className="text-gray-700 hover:text-afroGreen font-medium px-4 py-2">
            {t('nav.compare')}
          </Link>
        </NavigationMenuItem>

        <NavigationMenuItem>
          <Link to="/about" className="text-gray-700 hover:text-afroGreen font-medium px-4 py-2">
            {t('nav.about')}
          </Link>
        </NavigationMenuItem>
      </NavigationMenuList>
