...
export const EnhancedReviewSection: React.FC<EnhancedReviewSectionProps> = ({ productId }) => {
  const { user } = useAuth();
            ...
            <div className="text-center">
              <div className="mb-4">
                ...
                <p className="text-gray-600 mb-4">
                  Avez-vous utilisé ce produit ? Aidez les autres utilisateurs avec votre avis détaillé !
                </p>
              </div>
              ...
              <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                <TabsList className="grid w-full lg:w-auto grid-cols-2 lg:grid-cols-4">
                  ...
                  <TabsTrigger value="with-photos">
                    Avec photos ({reviews?.filter(r => r.photos?.length).length || 0})
                  </TabsTrigger>
                  <TabsTrigger value="verified">
                    Vérifiés ({reviews?.filter(r => r.is_verified_purchase).length || 0})
                  </TabsTrigger>
                ...
                {filteredReviews.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">
                      {activeTab === 'with-photos' && 'Aucun avis avec photos pour le moment.'}
                      {activeTab === 'verified' && 'Aucun avis d\'achat vérifié pour le moment.'}
                      {activeTab === 'recent' && 'Aucun avis récent pour le moment.'}
                      {activeTab === 'all' && 'Aucun avis pour le moment.'}
                    </p>
                  </div>
                )}
              </TabsContent>
