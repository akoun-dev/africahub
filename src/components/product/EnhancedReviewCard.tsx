...
import { useVoteOnReview, useReportReview, useDeleteReview } from '@/hooks/useReviews';
...
export const EnhancedReviewCard: React.FC<EnhancedReviewCardProps> = ({ review, onEdit }) => {
  const { user } = useAuth();
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <h4 className="font-medium text-gray-900">Utilisateur vérifié</h4>
              ...
              <h5 className="font-semibold mb-2 text-gray-900">{review.title}</h5>
              ...
              <div className="flex items-center gap-6 text-sm border-t pt-4">
                <button
                  ...
                  disabled={!user || voteOnReviewMutation.isPending}
                ...
                {!isOwnReview && (
                  <button
                    ...
                    disabled={!user || reportReviewMutation.isPending}
