...
import { Shield, Banknote, Smartphone, Zap, Car, Home, Sprout, BookOpen } from 'lucide-react';
import { useSectorCMSContent } from '@/hooks/useSectorCMSContent';

const iconMap = {
  Shield, Banknote, Smartphone, Zap, Car, Home, Sprout, BookOpen
};
...
export const CMSSectorFeatures: React.FC<CMSSectorFeaturesProps> = ({
  ...
  if (isLoading || !content.features || content.features.length === 0) {
    return null;
  }
