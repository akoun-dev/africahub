...
export const PremiumSectorHero: React.FC<PremiumSectorHeroProps> = ({
    ...
    // Gestion sécurisée du contenu CMS avec valeurs par défaut
    const title = content?.hero?.title || sector.name
    const description = content?.hero?.description || sector.description
    const ctaText = content?.hero?.cta_text || "Comparer les offres"
            ...
            <div className="container px-4 md:px-6 relative z-10">
                <div className="max-w-4xl text-white">
                    ...
                    >
                        ...
                        {/* Country-specific information - Temporairement désactivé */}
                        {/* TODO: Ajouter regulatory_info à la structure CMS */}
                        ...
                        >
                            <Button
                                ...
                                onClick={() =>
                                    navigate(`/secteur/${sector.slug}/comparer`)
                                }
                            >
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    navigate(`/secteur/${sector.slug}/devis`)
                                }
                            >
