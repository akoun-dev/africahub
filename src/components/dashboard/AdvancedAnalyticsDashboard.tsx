    ...
    return (
        <div className="space-y-6 p-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-600">
                        Insights en temps réel et métriques de performance
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-[#2D4A6B]">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-[#2D4A6B] text-sm font-medium">
                                    Recherches totales
                                </p>
                                ...
                                <p className="text-xs text-[#2D4A6B]">
                                    +23% vs période précédente
                                </p>
                            </div>
                            <Search className="h-8 w-8 text-[#2D4A6B]" />
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-[#1F3A5F]">
                                    {metrics?.avg_search_time || 142}ms
                                </p>
                                <p className="text-xs text-[#2D4A6B]">
                                    -8% amélioration
                                </p>
                            </div>
                            <Clock className="h-8 w-8 text-[#2D4A6B]" />
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-[#2D4A6B]">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Zap className="h-8 w-8 text-[#2D4A6B]" />
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-[#1F3A5F]">
                                    {Math.round(
                                        (metrics?.conversion_rate || 0.27) * 100
                                    )}
                                    %
                                </p>
                                <p className="text-xs text-[#2D4A6B]">
                            ...
                            <Target className="h-8 w-8 text-[#2D4A6B]" />
                        </div>
                    </CardContent>
                </Card>
            </div>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Badge
                                            variant="default"
                                            className="bg-[#2D4A6B] text-white"
                                        >
                                            {Math.round(
                                ...
                                <div className="space-y-3">
                                    <div className="p-3 bg-blue-50 rounded-lg">
                                        ...
                                        <p className="text-xs text-blue-700">
                                            Augmenter la durée de cache pour les
