    ...
    const insights = [
        {
            ...
            description:
                "Assurance auto : économie potentielle de 15% identifiée",
            confidence: 0.85,
        ...
        },
        {
            ...
            description:
                "Les prix d'assurance habitation baissent dans votre région",
            confidence: 0.72,
            ...
            <CardContent className="space-y-3">
                {insights.length > 0 ? (
                    insights.map((insight, index) => (
                        <div
                            key={index}
                            className="border border-afroGreen/10 rounded-lg p-3 space-y-2 bg-white/50 backdrop-blur-sm hover:bg-white/70 transition-all"
                        >
                            <div className="flex items-start justify-between">
                                <div className="flex-1">
                                    <div className="flex items-center space-x-2 mb-1">
                                        {insight.type === "opportunity" && (
                                            <TrendingUp className="h-4 w-4 text-afroGreen" />
                                        )}
                                        {insight.type === "trend" && (
                                            <AlertCircle className="h-4 w-4 text-afroGold" />
                                        )}
                                        {insight.type === "recommendation" && (
                                            <Brain className="h-4 w-4 text-afroRed" />
                                        )}
                                    ...
                                    <div className="flex items-center justify-between">
                                        <Badge
                                            variant="outline"
                                            className="text-xs border-afroGreen/30 text-afroGreen"
                                        >
                                            {Math.round(
                                        ...
                                        <Button
                                            size="sm"
                                            variant="outline"
                                            className="border-afroGreen/30 text-afroGreen hover:bg-afroGreen hover:text-white transition-all"
                                        >
                                            {insight.action}
                                        </Button>
                                    </div>
                    ...
                    <div className="text-center py-6">
                        ...
                        <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                            {t(
                                ...
                                "Commencez à explorer notre plateforme pour obtenir des recommandations et insights personnalisés."
                            )}
                        </p>
                        <Button
                            size="sm"
                ...
                {recommendations && recommendations.length > 0 && (
                    <div className="border-t border-afroGreen/20 pt-3 mt-4">
                        <p className="text-sm text-gray-600 mb-3">
                            <strong className="text-afroGreen">
                        ...
                        <Button
                            size="sm"
                            className="w-full bg-gradient-to-r from-afroGreen to-afroGold hover:from-afroGreen-dark hover:to-afroGold-dark text-white shadow-lg hover:shadow-xl transition-all"
                        >
                            {t(
