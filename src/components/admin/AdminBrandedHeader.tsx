        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">Plateforme Multi-Sectorielle</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          {adminUser && (
            <div className="flex items-center space-x-2">
              <Badge variant={getRoleBadgeVariant(adminUser.roles)} className="bg-white/20 text-white border-white/30">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-12 w-12 rounded-full bg-white/20 hover:bg-white/30 text-white">
