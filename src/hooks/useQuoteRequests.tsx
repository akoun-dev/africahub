...
type SupabaseQuoteRequestInsert =
    Database["public"]["Tables"]["quote_requests"]["Insert"]
type SupabaseQuoteRequestUpdate =
    Database["public"]["Tables"]["quote_requests"]["Update"]
...
export const useCreateQuoteRequest = () => {
    ...
    return useMutation({
        mutationFn: async (
            quoteData: Omit<SupabaseQuoteRequestInsert, "user_id">
        ) => {
...
export const useUpdateQuoteRequest = () => {
    ...
    return useMutation({
        mutationFn: async ({
            ...
            id: string
            updates: SupabaseQuoteRequestUpdate
        }) => {
            const { data, error } = await supabase
                .from("quote_requests")
                .update(updates)
