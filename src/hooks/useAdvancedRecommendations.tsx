...
export const useAdvancedRecommendations = (insuranceType?: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      console.log('Fetching advanced recommendations for user:', user.id, 'type:', insuranceType);
      ...
      return recommendations.map(rec => {
        ...
        return {
          ...
          recommendation_type: rec.recommendation_type as 'behavioral' | 'collaborative' | 'content' | 'hybrid',
...
export const useUpdateRecommendationInteraction = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['advanced-recommendations'] });
    },
  });
};
...
export const useGenerateAdvancedRecommendations = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['advanced-recommendations', user?.id] });
    },
  });
};
