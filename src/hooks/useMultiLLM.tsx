...
export const useLLMProviderStatus = () => {
  return useQuery({
    ...
    queryFn: async () => {
      return {
        openai: { available: true, latency: 150, model: 'gpt-4o-mini', cost_per_1m: 0.15 },
        anthropic: { available: true, latency: 200, model: 'claude-3-haiku', cost_per_1m: 0.25 },
        deepseek: { available: true, latency: 300, model: 'deepseek-chat', cost_per_1m: 0.07 },
        qwen: { available: true, latency: 250, model: 'qwen-turbo', cost_per_1m: 0.12 }
      };
    }
  });
};
...
export const useMultiLLMChat = () => {
  ...
  const sendMessage = useMutation({
    mutationFn: async (params: string | { 
      ...
      return {
        content: "Je suis un assistant AI qui peut vous aider avec vos questions d'assurance.",
        provider: 'openai',
        model: 'gpt-4o-mini',
        cost_estimate: 0.002,
