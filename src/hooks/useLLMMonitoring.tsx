            ...
            const mockAlerts: LLMAlert[] = [
                {
                    ...
                    severity: "high",
                    message:
                        "Provider OpenAI: Latence élevée détectée (>3000ms)",
                    provider: "openai",
    ...
    const optimizeRouting = useMutation({
        ...
        onSuccess: () => {
            toast({
                ...
                description:
                    "Les paramètres de routage ont été optimisés automatiquement.",
            })
        ...
        onError: () => {
            toast({
                ...
                description:
                    "Impossible d'optimiser automatiquement les paramètres.",
                variant: "destructive",
            })
        },
    })
    ...
    const resetToDefaults = useMutation({
        ...
        onSuccess: () => {
            toast({
                ...
                description:
                    "Les paramètres ont été remis aux valeurs par défaut.",
            })
            queryClient.invalidateQueries({
                queryKey: ["user-llm-preferences"],
            })
