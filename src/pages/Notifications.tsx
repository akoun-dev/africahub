...
const mockNotifications = [
  {
    ...
    message: 'Un nouveau produit d\'assurance auto est disponible chez NSIA.',
    is_read: false,
  ...
  },
  {
    ...
    message: 'Nous avons trouvé 3 nouvelles offres qui pourraient vous intéresser.',
    is_read: true,
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-2xl font-bold mb-4">Accédez à vos notifications</h1>
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start justify-between">
                            <div className="flex items-start gap-4 flex-1">
                              <div className={`w-3 h-3 rounded-full mt-2 ${getNotificationColor(notification.type)}`}>
                              </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => 
                              setPreferences(prev => ({ ...prev, new_products: checked }))
                            }
                          />
                        </div>
                        <div className="flex items-center justify-between">
                          <Label htmlFor="price-changes">Changements de prix</Label>
                          <Switch
                            id="price-changes"
                            checked={preferences.price_changes}
                            onCheckedChange={(checked) => 
                              setPreferences(prev => ({ ...prev, price_changes: checked }))
                            }
                          />
                        </div>
                        <div className="flex items-center justify-between">
                          <Label htmlFor="recommendations">Recommandations IA</Label>
                          <Switch
                            id="recommendations"
