      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <Users className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <Store className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
              <div className="text-2xl font-bold" style={{color: '#2D4A6B'}}>
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <Package className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
              <div className="text-2xl font-bold" style={{color: '#2D4A6B'}}>
              ...
              <p className="text-xs text-blue-600 mt-1">
                {platformStats.activeProducts.toLocaleString()} actifs
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <DollarSign className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
              <div className="text-2xl font-bold" style={{color: '#2D4A6B'}}>
            ...
            <CardContent>
              <div className="space-y-4">
                {pendingActions.map((action) => (
                  <div key={action.id} className="flex items-center justify-between p-3 border rounded-lg hover:shadow-md transition-shadow">
        ...
        <Card>
          <CardHeader>
            <CardTitle style={{color: '#2D4A6B'}}>Outils d'Administration</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link to="/admin/merchants">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <Store className="w-6 h-6" style={{color: '#2D4A6B'}} />
              ...
              <Link to="/admin/system">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <Database className="w-6 h-6" style={{color: '#2D4A6B'}} />
              ...
              <Link to="/admin/settings">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <Settings className="w-6 h-6" style={{color: '#2D4A6B'}} />
