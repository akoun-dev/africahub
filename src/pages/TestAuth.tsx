            ...
            <Route path="/admin/dashboard" element={
              <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-pink-100">
                <div className="text-center p-8 bg-white rounded-lg shadow-lg max-w-md">
                  ...
                  <p className="text-gray-600 mb-4">
                    Bienvenue dans l'interface d'administration AfricaHub.
                  </p>
                  <div className="text-sm text-gray-500 bg-gray-50 p-3 rounded">
                    <p><strong>Type :</strong> Administrateur</p>
                    <p><strong>Accès :</strong> Gestion complète de la plateforme</p>
                    <p><strong>Permissions :</strong> Toutes</p>
                  </div>
                </div>
              </div>
            } />
            ...
            <Route path="/manager/dashboard" element={
              <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-cyan-100">
                <div className="text-center p-8 bg-white rounded-lg shadow-lg max-w-md">
                  ...
                  <p className="text-gray-600 mb-4">
                    Bienvenue dans l'interface de gestion AfricaHub.
                  </p>
                  <div className="text-sm text-gray-500 bg-gray-50 p-3 rounded">
                    <p><strong>Type :</strong> Gestionnaire</p>
                    <p><strong>Accès :</strong> Modération et rapports</p>
                    <p><strong>Permissions :</strong> Gestion de contenu</p>
                  </div>
                </div>
              </div>
            } />
