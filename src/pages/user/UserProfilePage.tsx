...
export const UserProfilePage: React.FC = () => {
  const { profile, updateProfile } = useEnhancedAuth();
  ...
  const countries = [
    'Côte d\'Ivoire', 'Sénégal', 'Mali', 'Burkina Faso', 'Ghana', 'Nigeria',
    'Cameroun', 'Gabon', 'Congo', 'RDC', 'Kenya', 'Tanzanie', 'Ouganda',
    'Rwanda', 'Éthiopie', 'Maroc', 'Tunisie', 'Algérie', 'Égypte', 'Afrique du Sud'
  ];
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
              <div className="relative">
                <Avatar className="w-24 h-24">
                  ...
                  <AvatarFallback className="text-lg" style={{backgroundColor: '#2D4A6B20', color: '#2D4A6B'}}>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-slate-600">Alertes par SMS</p>
                        </div>
                        <Switch
                          id="smsNotif"
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Dernière modification il y a 3 mois</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Gérez vos connexions</p>
                    </div>
                    <Button variant="outline">
                      Voir
                    </Button>
