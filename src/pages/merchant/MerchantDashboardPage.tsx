...
export const MerchantDashboardPage: React.FC = () => {
  ...
  const getVerificationStatusBadge = () => {
    const status = profile?.merchant_profile?.verification_status || 'pending';
      ...
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-2">
              <h1 className="text-3xl font-bold" style={{color: '#2D4A6B'}}>
                {profile?.merchant_profile?.business_name || 'Mon Commerce'}
              </h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <Eye className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
              <div className="text-2xl font-bold" style={{color: '#2D4A6B'}}>
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <ShoppingBag className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
              <div className="text-2xl font-bold" style={{color: '#2D4A6B'}}>
        ...
        <Card>
          <CardHeader>
            <CardTitle style={{color: '#2D4A6B'}}>Actions Rapides</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link to="/merchant/orders">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <ShoppingBag className="w-6 h-6" style={{color: '#2D4A6B'}} />
