      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <div className="flex items-center space-x-2 mt-2">
              <Badge variant="secondary">
                Département: {profile?.department || 'Modération'}
              </Badge>
          ...
          <div className="flex items-center space-x-4 mt-4 lg:mt-0">
            ...
            <Link to="/manager/tools">
              <Button size="sm" style={{backgroundColor: '#2D4A6B'}} className="text-white">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <Clock className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
              <div className="text-2xl font-bold" style={{color: '#2D4A6B'}}>
                {moderationStats.pendingReviews}
              </div>
              <p className="text-sm text-slate-600">En attente</p>
              <p className="text-xs text-yellow-600 mt-1">Révisions</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <CheckCircle className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
              <div className="text-2xl font-bold" style={{color: '#2D4A6B'}}>
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <div className="flex items-center justify-center mb-2">
                <AlertTriangle className="w-8 h-8" style={{color: '#2D4A6B'}} />
              </div>
              <div className="text-2xl font-bold" style={{color: '#2D4A6B'}}>
            ...
            <CardContent>
              <div className="space-y-4">
                {pendingTasks.map((task) => (
                  <div key={task.id} className="flex items-center justify-between p-3 border rounded-lg hover:shadow-md transition-shadow">
                    <div className="flex-1">
                      <h4 className="font-medium text-slate-900">{task.title}</h4>
                      <p className="text-sm text-slate-600">{task.category}</p>
                      <div className="flex items-center space-x-2 mt-1">
                        <span className="text-lg font-bold" style={{color: '#2D4A6B'}}>
                          {task.count}
                        </span>
                  ...
                  <div className="w-full bg-slate-200 rounded-full h-2">
                    <div className="flex h-2 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{
                          width: `${(category.approved / (category.pending + category.approved + category.rejected)) * 100}%`
                        }}
                      ></div>
                      <div 
                        className="bg-yellow-500" 
                        style={{
                          width: `${(category.pending / (category.pending + category.approved + category.rejected)) * 100}%`
                        }}
                      ></div>
                      <div 
                        className="bg-red-500" 
                        style={{
                          width: `${(category.rejected / (category.pending + category.approved + category.rejected)) * 100}%`
                        }}
                      ></div>
                    </div>
                  </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle style={{color: '#2D4A6B'}}>Outils de Modération</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link to="/manager/merchants">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <Users className="w-6 h-6" style={{color: '#2D4A6B'}} />
              ...
              <Link to="/manager/reviews">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <MessageSquare className="w-6 h-6" style={{color: '#2D4A6B'}} />
              ...
              <Link to="/manager/reports">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <Flag className="w-6 h-6" style={{color: '#2D4A6B'}} />
              ...
              <Link to="/manager/analytics">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <BarChart3 className="w-6 h-6" style={{color: '#2D4A6B'}} />
              ...
              <Link to="/manager/search">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <Search className="w-6 h-6" style={{color: '#2D4A6B'}} />
              ...
              <Link to="/manager/filters">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <Filter className="w-6 h-6" style={{color: '#2D4A6B'}} />
              ...
              <Link to="/manager/compliance">
                <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center space-y-2">
                  <Shield className="w-6 h-6" style={{color: '#2D4A6B'}} />
        ...
        <div className="grid lg:grid-cols-3 gap-4">
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-slate-600">Taux d'approbation</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-slate-600">Satisfaction qualité</p>
            </CardContent>
          </Card>
        </div>
      </div>
